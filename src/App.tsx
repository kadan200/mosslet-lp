...
// ─── Google Fonts ─────────────────────────────────────────────────────────────
// DM Serif Display (display headings) × DM Sans (body)
...
:root {
  ...
  /* Palette - warm stone + deep ink + sage accent */
  --bg:           #f7f5f0;
  --bg-alt:       #eeeae2;
  --card:         #ffffff;
  --ink:          #19170f;
...
/* Link hover - opacity only (compositor-safe) */
.link-btn {
...
// ─── Card primitive ───────────────────────────────────────────────────────────
const Card = ({ children, style = {}, as: Component = "div", ...rest }: any) => (
  <Component
    style={{
      background: "var(--card)",
...
const Hero = () => (
  <header style={{ background: "var(--bg)", overflow: "hidden", position: "relative" }}>
    {/* Soft atmospheric glow - purely decorative, opacity only */}
    <div
      aria-hidden="true"
      style={{
        position: "absolute",
        ...
        background: "radial-gradient(circle at 65% 25%, rgba(58,97,68,0.08) 0%, transparent 70%)",
        pointerEvents: "none",
      }}
    />
    ...
    <div style={{
      ...
      maxWidth: "72rem",
      margin: "0 auto",
      padding: "clamp(4rem, 8vw, 7rem) clamp(1.5rem, 5vw, 4rem) clamp(3.5rem, 7vw, 6rem)",
      display: "grid",
    ...
    >
      ...
      <div>
        ...
        <p style={{
          ...
          テーマは
          <strong style={{ color: "var(--ink)", fontWeight: 600 }}>「作る楽しさを広げる」</strong>。
          生成AIで制作した全12絵柄のポストカードを展示・販売します。
          ご来場者とのポストカード交換企画も実施予定です。
        </p>
      </div>
    ...
    {/* Responsive tweak for single-column below lg */}
    <style>{`
...
const PurchaseSection = () => (
  <section
    ...
    style={{ background: "var(--bg)", padding: "clamp(4rem, 8vw, 7rem) clamp(1.5rem, 5vw, 4rem)" }}
  >
    <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
      ...
      <div style={{ maxWidth: "48rem" }}>
        ...
        <div className="pricing-grid" style={{ display: "grid", gap: "1rem", marginBottom: "1rem" }}>
          {/* Price card */}
        ...
        >
          <IconInfo />
          <div>
            <h3 style={{ fontSize: "0.8125rem", fontWeight: 600, marginBottom: "0.375rem" }}>
              お支払いについて
            </h3>
            <p style={{ fontSize: "0.8125rem", lineHeight: 1.85, color: "var(--ink)", textWrap: "pretty" as any }}>
              お支払いは<strong style={{ fontWeight: 600 }}> 現金のみ </strong>です。
              小銭や千円札でのお支払いにご協力いただけますと助かります。
            </p>
          </div>
        </div>
      </div>
...
const ExchangeSection = () => (
  <section
    ...
    style={{ background: "var(--bg-alt)", padding: "clamp(4rem, 8vw, 7rem) clamp(1.5rem, 5vw, 4rem)" }}
  >
    <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
      <SectionHead eyebrow="Card Exchange" title="ポストカード交換企画" id="exchange-heading" />

      <div className="exchange-grid" style={{ display: "grid", gap: "2rem" }}>
        <div>
          <p style={{
            fontSize: "0.9375rem",
            lineHeight: 1.9,
            ...
            「作る楽しさを広げる」試みとして、ご自身で制作したポストカードとの
            交換企画を行います。ブース内限定の小さな交換企画です。
          </p>
          ...
          <Card style={{ padding: "clamp(1.25rem, 3vw, 2rem)" }}>
            ...
            <ol
              role="list"
              style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.875rem" }}
            >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <Card style={{ padding: "1.5rem" }}>
            ...
            <p style={{
              ...
              ご自身の画像でコンビニ印刷できる
              ネットプリント用Canvaテンプレートをご用意しています。
            </p>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              <a
                href="https://canva.link/z0sz1nkhmn14nud"
                target="_blank"
              ...
              <a
                href="https://canva.link/vvdbm7te2p71ir4"
                target="_blank"
                rel="noopener noreferrer"
                className="link-btn"
                style={{
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "0.8125rem", lineHeight: 1.85, textWrap: "pretty" as any }}>
                この企画は<strong style={{ fontWeight: 600 }}> mosslet </strong>ブース限定です。来場者同士での交換・配布や、他サークル様への交換交渉はご遠慮ください。
              </p>
            </div>
          </div>
        </div>
      ...
      <style>{`
        ...
        @media (min-width: 900px) {
          .exchange-grid { grid-template-columns: minmax(0,1.2fr) minmax(280px,0.8fr); }
        }
      `}</style>
    </div>
  </section>
  ...
  >
    <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
      ...
      <Card style={{ padding: "clamp(1.5rem, 4vw, 2.5rem)", maxWidth: "48rem" }}>
        <p style={{ fontSize: "0.875rem", lineHeight: 1.9, color: "var(--body)", marginBottom: "1.5rem" }}>
          半スペースでの出展のため、当日は以下にご協力をお願いいたします。
        </p>
        <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "1rem" }}>
          {NOTICES.map((notice, i) => (
            <li key={i} style={{ display: "flex", gap: "0.875rem", alignItems: "flex-start" }}>
              ...
              <span style={{ fontSize: "0.875rem", lineHeight: 1.9, color: "var(--body)" }}>{notice}</span>
            </li>
          ))}
        </ul>
      </Card>
...
const Footer = () => (
  <footer style={{ background: "var(--ink)", color: "rgba(247,245,240,0.9)", padding: "clamp(3.5rem, 7vw, 5.5rem) clamp(1.5rem, 5vw, 4rem)" }}>
    <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
      ...
      <div style={{ height: "1px", background: "rgba(255,255,255,0.1)", marginBottom: "1.75rem" }} aria-hidden="true" />
